...
Copy to `~/.config/helix/themes/` and set `theme = "serendipity-midnight"` in config.toml.

Available files: `themes/serendipity-midnight.toml`, `themes/serendipity-morning.toml`, `themes/serendipity-sunset.toml`.
